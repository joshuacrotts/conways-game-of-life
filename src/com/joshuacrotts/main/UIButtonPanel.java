...
public class UIButtonPanel extends JPanel {
  ...
  private static final int RANDOMIZE_BUTTON_COL = 2;
  private static final int CLEAR_BUTTON_COL = 3;
  private static final int FRAMERATE_SLIDER_COL = 4;
  private static final int GENERATION_LABEL_COL = 5;
